...
namespace DragonExMiningSampleCSharp.Apis.DragonEx
{
    class DragonExPrivateApis
    {
        ...
        public DragonExPrivateApis(string secretKey, string accessKey)
        {
        ...
        private string ApiPostQuery(string apiRelativePath, IDictionary<string, string> req, bool isGettingToken = false)
        {
            ...
            var sign = GetSign(secretKey, method, apiRelativePath, headerDict);
            string auth = String.Format("{0}:{1}", accessKey, sign);
